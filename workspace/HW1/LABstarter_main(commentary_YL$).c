...
void main(void)
{
    ...
    ConfigCpuTimer(&CpuTimer2, LAUNCHPAD_CPU_FREQUENCY, 25000);//YL$ Exercise3_2 Since timer2's interrupt function is called every 25 ms and the modulus is 10 in Timer 2’s interrupt function, serial_printf function is called every 250ms.
    //YL$ Exercise3_3 Since timer2's interrupt function is called every 25 ms, if CpuTimer2.InterruptCount has incremented to 3721, it would take 3721*0.25 = 1,860.75 sec.
